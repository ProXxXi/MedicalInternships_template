...
public class Australia extends AppCompatActivity {
    ...
    CharSequence Titles[]={"Сидней","Мельбурн", "Аделаида", "Мельбурн"};
    int Numboftabs =4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.logo_australia);
        ...
        public void onClick(View view) {
            if (view == fabShare) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "\n" +
                        "Стажировки в Австралии (Сидней, Аделаида, Мельбурн) и другие возможности только в приложении Медицинские стажировки (Google Play),  узнать подробнее о стажировках - medicalinternshipsksm@gmail.com\n");
                ...
                try {
                    ...
                    Toast.makeText(Australia.this, "Пожалуйста загрузите подходящее приложение из Google Play", Toast.LENGTH_SHORT).show();
                }
            } else {
