...
public class Austria extends AppCompatActivity {
    ...
    Toolbar toolbar;
    ViewPager pager;
    ViewPagerAdapteAustria adapter;
    SlidingTabLayout tabs;
    CharSequence Titles[]={"Грац","Грац"};
    int Numboftabs = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.logo_austria);
        ...
        adapter =  new ViewPagerAdapteAustria(getSupportFragmentManager(),Titles,Numboftabs);
            ...
            public void onClick(View view) {
                if (view == fabShare) {
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT, "\n" +
                            "Стажировки в Австрии (Грац, Инсбрук) и другие возможности только в приложении Медицинские стажировки (Google Play), узнать подробнее о стажировках - medicalinternshipsksm@gmail.com\n");
                    ...
                    try {
                        ...
                        Toast.makeText(Austria.this, "Пожалуйста загрузите подходящее приложение из Google Play", Toast.LENGTH_SHORT).show();
                    }
                } else {
