...
public class Czech extends AppCompatActivity {
    ...
    Toolbar toolbar;
    ViewPager pager;
    ViewPagerAdapterCzech adapter;
    SlidingTabLayout tabs;
    CharSequence Titles[]={"Градец-Кралове","Прага"};
    int Numboftabs = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter =  new ViewPagerAdapterCzech(getSupportFragmentManager(),Titles,Numboftabs);
            ...
            public void onClick(View view) {
                if (view == fabShare) {
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT, "\n" +
                            "Стажировки в Чехии (Прага, Градец-Кралове) и другие возможности только в приложении Медицинские стажировки (Google Play),  узнать подробнее о стажировках - medicalinternshipsksm@gmail.com\n");
                    ...
                    try {
                        ...
                        Toast.makeText(Czech.this, "Пожалуйста загрузите подходящее приложение из Google Play", Toast.LENGTH_SHORT).show();
                    }
                } else {
