...
public class GeneralEng extends AppCompatActivity {

    // Declaring Your View and Variables

    Toolbar toolbar;
    ViewPager pager;
    ViewPagerAdapterGeneralEng adapter;
    SlidingTabLayout tabs;
    CharSequence Titles[]={"Лондон","Ливерпуль","Оксфорд","Дублин","Брей","Бостон","Лос-Анджелес","Ванкувер","Торонто","Брисбен","Борнмут"};
    int Numboftabs = 11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter =  new ViewPagerAdapterGeneralEng(getSupportFragmentManager(),Titles,Numboftabs);
            ...
            public void onClick(View view) {
                if (view == fabShare) {
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT, "\n" +
                            "Изучение английского за рубежом (Великобритания, США, Канада) и другие возможности только в приложении Медицинские стажировки (Google Play), узнать подробнее - medicalinternshipsksm@gmail.com\n");
                    ...
                    try {
                        ...
                        Toast.makeText(GeneralEng.this, "Пожалуйста загрузите подходящее приложение из Google Play", Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    public void onBackPressed() {
        GeneralEng.super.onBackPressed();
        finish();
    }
