...
public class IeltsToefl extends AppCompatActivity {

    // Declaring Your View and Variables

    Toolbar toolbar;
    ViewPager pager;
    ViewPagerAdapterIeltsToefl adapter;
    SlidingTabLayout tabs;
    CharSequence Titles[]={"Дублин","Лондон","Ливерпуль","Борнмут","Оксфорд","Брей","Бостон","Лос-Анджелес","Ванкувер","Торонто","Брисбен"};
    int Numboftabs = 11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_general_eng);
        setTitle(R.string.logo_eltstoefl);
        ...
        adapter =  new ViewPagerAdapterIeltsToefl(getSupportFragmentManager(),Titles,Numboftabs);
            ...
            public void onClick(View view) {
                if (view == fabShare) {
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT, "\n" +
                            "Подготовка к IELTS и TOEFL за рубежом (Великобритания, США, Канада) и другие возможности только в приложении Медицинские стажировки (Google Play),  узнать подробнее - medicalinternshipsksm@gmail.com\n");
                    ...
                    try {
                        ...
                        Toast.makeText(IeltsToefl.this, "Пожалуйста загрузите подходящее приложение из Google Play", Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    public void onBackPressed() {
        IeltsToefl.super.onBackPressed();
        finish();
    }
