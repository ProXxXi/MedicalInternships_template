...
public class Israel extends AppCompatActivity {

    // Declaring Your View and Variables

    Toolbar toolbar;
    ViewPager pager;
    ViewPagerAdapterIsrael adapter;
    SlidingTabLayout tabs;
    CharSequence Titles[]={"Хайфа","Хайфа"};
    int Numboftabs = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter =  new ViewPagerAdapterIsrael(getSupportFragmentManager(),Titles,Numboftabs);
            ...
            public void onClick(View view) {
                if (view == fabShare) {
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT, "\n" +
                            "Стажировки в Израиле (Хайфа) и другие возможности только в приложении Медицинские стажировки (Google Play), узнать подробнее о стажировках - medicalinternshipsksm@gmail.com\n");
                    ...
                    try {
                        ...
                        Toast.makeText(Israel.this, "Пожалуйста загрузите подходящее приложение из Google Play", Toast.LENGTH_SHORT).show();
                    }
                } else {
