...
public class MedEng extends AppCompatActivity {

    // Declaring Your View and Variables

    Toolbar toolbar;
    ViewPager pager;
    ViewPagerAdapterMedEng adapter;
    SlidingTabLayout tabs;
    CharSequence Titles[]={"Лондон","Манчестер"};
    int Numboftabs = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_med_eng);
        setTitle(R.string.logo_medeng);
        ...
        adapter =  new ViewPagerAdapterMedEng(getSupportFragmentManager(),Titles,Numboftabs);
            ...
            public void onClick(View view) {
                if (view == fabShare) {
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT, "\n" +
                            "Изучение медицинского английского за рубежом (Лондон, Манчестер) и другие возможности только в приложении Медицинские стажировки (Google Play),  узнать подробнее - medicalinternshipsksm@gmail.com\n");
                    ...
                    try {
                        ...
                        Toast.makeText(MedEng.this, "Пожалуйста загрузите подходящее приложение из Google Play", Toast.LENGTH_SHORT).show();
                    }
                } else {
