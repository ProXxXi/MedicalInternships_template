...
public class SouthKorea extends AppCompatActivity {
    ...
    Toolbar toolbar;
    ViewPager pager;
    ViewPagerAdapterSouthKorea adapter;
    SlidingTabLayout tabs;
    CharSequence Titles[]={"Сеул","Сеул","Сеул"};
    int Numboftabs = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.logo_south_korea);
        ...
        adapter =  new ViewPagerAdapterSouthKorea(getSupportFragmentManager(),Titles,Numboftabs);
            ...
            public void onClick(View view) {
                if (view == fabShare) {
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT, "\n" +
                            "Стажировки в Южной Корее (Сеул) и другие возможности только в приложении Медицинские стажировки (Google Play), узнать подробнее о стажировках - medicalinternshipsksm@gmail.com\n");
                    ...
                    try {
                        ...
                        Toast.makeText(SouthKorea.this, "Пожалуйста загрузите подходящее приложение из Google Play", Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    public void onBackPressed() {
        SouthKorea.super.onBackPressed();
        finish();
    }
