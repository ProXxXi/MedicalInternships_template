...
public class Usa extends AppCompatActivity {
    ...
    Toolbar toolbar;
    ViewPager pager;
    ViewPagerAdapterUsa adapter;
    SlidingTabLayout tabs;
    CharSequence Titles[]={"Кливленд","Нью-Йорк", "Лос-Анджелес", "Питтсбург", "Бостон", "Кливленд"};
    int Numboftabs =6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter =  new ViewPagerAdapterUsa(getSupportFragmentManager(),Titles,Numboftabs);
            ...
            public void onClick(View view) {
                if (view == fabShare) {
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT, "\n" +
                            "Стажировки в США (Бостон, Кливленд, Лос-Анджелес, Нью-Йорк, Питтсбург) и другие возможности только в приложении Медицинские стажировки (Google Play), узнать подробнее о стажировках - medicalinternshipsksm@gmail.com\n");
                    ...
                    try {
                        ...
                        Toast.makeText(Usa.this, "Пожалуйста загрузите подходящее приложение из Google Play", Toast.LENGTH_SHORT).show();
                    }
                } else {
